#############################################################
 ### SHARED AND UNIQUE ASVs -- 16S
#############################################################

## THROUGHOUT: Abundance filter >= 0.01%
# OrgSW + Ctr
core1 <- ASV.bac.rel %>%
...
# e.g. remove some UC taxa (especially if related, known genera are present)
