...
setwd("~/AWI_MPI/FRAM/IceExp/Rstats")
...
# Load taxonomy table
# Rename PR2 taxranks 
# Remove Supergroup (=align with 16S taxonomy)
TAX.euk <- read.table(
...
# Function for presence-absence analysis
